...
| 4 | Warum lineare Regression fuer Klassifikation schwach ist | 2 | 0 | 2 |
...
| 13 | Log-Loss-Idee (groesserer Fehler -> groesserer Verlust) | 2 | 0 | 2 |
| 14 | Loesungsweg via Gradient Descent | 2 | 0 | 2 |
| 15 | Mehrklassen als wiederholte binaere Fragen (OvR-Idee) | 2 | 0 | 2 |
...
- **Thema 4, Schritt 8:** Log-Loss, Gradient Descent, Mehrklassen-Bruecke, Uebergang zu Matrixform (`sigmoid(X*b)`).
...
- Grenzen linearer Regression fuer Klassen: Zeilen 89-92
...
- Mehrklassen-Logik (wiederholte binaere Fragen): Zeile 252
...
4. Curriculum-README um die expliziten Logistik-Regressions-Bausteine ergaenzt.
