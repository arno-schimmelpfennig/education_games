...
| 2 | Überwachtes Lernen mit Train/Test-Kontext | 2 | 1 | 2 |
| 3 | KNN für Klassifikation und Regression | 2 | 0 | 2 |
| 4 | Unregelmäßige Entscheidungsgrenzen als KNN-Stärke | 2 | 0 | 2 |
| 5 | `k` als Nachbarschaftsidee + Mehrheitsprinzip | 2 | 0 | 2 |
| 6 | Ähnlichkeit über Distanz berechnen | 2 | 0 | 2 |
...
| 11 | Wirkung von kleinem/mittlerem/großem `k` | 2 | 0 | 2 |
...
| 16 | Manhattan-Distanz mit Straßennetz-Intuition | 2 | 0 | 2 |
| 17 | Minkowski als Generalisierung über Parameter `p` | 2 | 0 | 2 |
| 18 | Cosinus-Ähnlichkeit als Vektor-Idee (Suche/LLM-Brücke) | 2 | 0 | 2 |
| 19 | Skalierungspflicht bei Distanzmetriken (Achsendominanz) | 2 | 1 | 2 |
| 20 | Niedrigschwellige Tool-/Notebook-Führung für Aufgaben | 2 | 0 | 2 |
...
- Tool-/Notebook-Barrieren und Bedarf an klarer Führung: Zeilen 7-14, 21-23
- Einstieg KNN als anderes Modell: Zeilen 28-30, 47-51
- KNN-Kernidee (Nachbarn, Mehrheitsprinzip): Zeilen 52-63
- Distanz als Ähnlichkeitsgrundlage: Zeilen 63-67
...
- Mannheim-Grid als didaktische Brücke: Zeilen 165-173
- Minkowski (`p`) und Sonderfall: Zeilen 185-188
- Cosinus-Ähnlichkeit (Vektorraum, Suchmaschinen, LLM): Zeilen 199-205
...
2. Der rote Faden wurde um alltagsnahe Story-Elemente erweitert (Pendeln, Route, Einkaufs-/Produktbeispiele, Berlin/Nürnberg, Mannheim-Grid).
3. Benutzerführung wurde verpflichtend konkretisiert (10-Minuten-Ziel, 3-Klick-Anweisung, Hilfekanal pro Notebook-Aufgabe).
...
## Prüfung der Ergänzungen
- Reihenfolge geprüft: neue Schritte stehen logisch zwischen Klassifikation und Matrix.
- Didaktik geprüft: Einstieg ohne Mathehürde, dann schrittweise Formalisierung.
- Inhalt geprüft: alle wesentlichen Themenblöcke aus dem Transkript sind mindestens einmal explizit abgedeckt.
- Punktelogik geprüft: Nachher-Wert erreicht `40/40` und entspricht damit `100%` der definierten Kriterien.
